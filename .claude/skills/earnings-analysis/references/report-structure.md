...
This document provides complete section-by-section templates and formatting requirements for the earnings update Markdown (.md) report.
...
**Reference 2-3 charts here (Quickchart.io URL or fallback PNG):**
```markdown
*Figure 1 – Quarterly Revenue Progression*
![Figure 1 – Quarterly Revenue Progression](https://quickchart.io/chart?w=600&h=300&bkg=white&c={encoded_bar_config})
*Source: Company earnings releases*

*Figure 2 – Quarterly EPS Progression*
![Figure 2 – Quarterly EPS Progression](https://quickchart.io/chart?w=600&h=300&bkg=white&c={encoded_bar_config})
*Source: Company earnings releases*

*Figure 3 – Gross Margin Trends*
![Figure 3 – Gross Margin Trends](https://quickchart.io/chart?w=600&h=300&bkg=white&c={encoded_line_config})
*Source: Company earnings releases; Form 10-Q*
```
...
**Reference 2-3 chart images here:**
...
**Reference 1-2 chart images here:**
...
- Caption line above: `*Figure X – [Title]*`
- Embed as Quickchart.io URL (primary) or local PNG path (fallback)
- Source line below: `*Source: [document, date]*`
- URL format: `https://quickchart.io/chart?w=600&h=300&bkg=white&c={encoded_config}`
...
- ALL URLs must use markdown link syntax: display text in brackets, URL in parentheses
- Display text should be meaningful (not the raw URL)
- Every source citation should have a clickable markdown link where applicable
- No plain text URLs — always wrap in markdown link syntax
