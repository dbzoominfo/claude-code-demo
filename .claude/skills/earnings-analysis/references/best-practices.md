...
**Hyperlinks:** ⭐⭐⭐ CRITICAL
- [ ] ALL URLs formatted as markdown links — display text in brackets, URL in parentheses
- [ ] Display text is meaningful (not the raw URL)
- [ ] All SEC filings linked to EDGAR viewer
- [ ] All earnings materials linked (release, transcript, presentation)
- [ ] Prior quarter materials linked for comparison
- [ ] No raw plain-text URLs anywhere in the document
...
1. **Section 1**: Rating clear? Price target updated? Key takeaways compelling?
2. **Numbers**: Do reported results match company's press release exactly?
3. **Citations**: Spot check 3-4 figures/tables — all have sources with markdown hyperlinks?
4. **Estimates**: Old vs. new clearly shown? Changes explained?
5. **Charts**: All 8-12 PNG images referenced? All captioned with Figure N?
6. **Length**: Is it 8-12 sections / 3,000-5,000 words?
7. **Hyperlinks**: All links use markdown syntax — display text in brackets, URL in parentheses?
...
Deliverables:
✓ 8-12 section earnings update report (Markdown .md)
✓ 8-12 chart PNG images (in charts/ subfolder)
...
File: [Company]_Q[X]_[Year]_Earnings_Update.md
```
