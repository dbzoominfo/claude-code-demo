...
5. **Create Report** (8-12 sections):
   - Section 1: Summary with rating and price target
...
Provide:
1. **Markdown report (.md)** - 8-12 section earnings update
...
- [ ] All chart images referenced (8-12 total)
